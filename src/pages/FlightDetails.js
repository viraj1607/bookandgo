...
const FlightDetails = () => {
    ...
    return (
        <div>
            ...
            <HeaderContainerList />
            <FlightReview />
            <div className="flex items-center justify-between p-6 my-4 mx-auto w-[300px] md:w-[500px] lg:w-[706px] xl:w-[960px] h-auto md:h-[238px] rounded-[20px] bg-white shadow-lg">
