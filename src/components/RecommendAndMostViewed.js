...
const RecommendAndMostViewed = ({ title, flights }) => {
  return (
      ...
      <div className="p-4 w-full max-w-screen-xl">
        <div className="section-recommended">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[25px] pt-4">
            {recommendedHotelsList.map((hotel, index) => (
        ...
        <div className="flex justify-center items-center mt-10">
          <h2 className="md:text-[40px] text-[20px] sm:text-[30px] font-semibold font-extrabold">Most Viewed Flights</h2>
        </div>
          ...
          {flights.map((flight, index) => (
            ...
            >
              ...
              <div className="p-2 md:p-3">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="font-semibold text-[20px] md:text-[25px]">{flight.name}</h3>
                    <div className="flex justify-between items-center">
                      <p className="font-medium text-[12px] text-slate-500">{flight.location}</p>
                    </div>
                  </div>
                ...
                <div className="text-left mt-2">
                  <span className="font-semibold text-[12px] text-rose-600">Limited Offer</span>
                </div>
              </div>
            </div>
          ))}
