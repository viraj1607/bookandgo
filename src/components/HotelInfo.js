            ...
            <div className="flex flex-col h-fit p-4 my-8 mx-4 md:mx-16">
                <div className="grid grid-cols-3 grid-rows-2 gap-8">
                    <div className="col-span-2 row-span-2">
                        <img src={hotelData.img} alt="Image 1" className="rounded-xl w-full h-full object-cover"/>
                    </div>
                    <div className="col-span-1 row-span-1">
                        <img src={hotelData.img} alt="Image 2" className="rounded-xl w-full h-full object-cover"/>
                    </div>
                    <div className="col-span-1 row-span-1">
                        <img src={hotelData.img} alt="Image 3" className="rounded-xl w-full h-full object-cover"/>
                    </div>
                </div>
