...
const HeaderContainerList = () => {
  const { t } = useTranslation();

  return (
    <div className="header-container flex items-center w-[800px]  h-[110px] rounded-3xl shadow-custom-shadow bg-white justify-between md:mt-[-50px] mx-auto webkit-sticky sticky z-50 top-5">
